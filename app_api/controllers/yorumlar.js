    ...
    if(mekanid) {
        Mekan
            ...
            .exec((hata, gelenMekan) => {
                ...
                else { yorumOlustur(req, res, gelenMekan);
                }
        });
    } else {
...
const yorumGuncelle = function(req, res){
    ...
    .exec(function(hata, gelenMekan){
        ...
        if(gelenMekan.yorumlar && gelenMekan.yorumlar.length > 0){
            ...
            if(!yorum) {cevapOlustur(res,404 , {mesaj : "yorum id bulunamadı."});
        } else {
...
const yorumSil = function(req, res)
{
    ...
    .exec(function (hata, gelenMekan) 
    {
        if(!gelenMekan) {cevapOlustur(res,404, {"mesaj" : "mekanid bulunamadı"}); return;}
